...
# 导入雷达台站管理器
from radar_expert.radar_station_manager import RadarStationDatabase, RadarStation, BasicInfo, Location, Capability, Connectivity, PerformanceMetrics
...
def main():
    ...
    tab_radar_designer, tab_simulator = st.tabs(["📊 雷达参数优化器", "⚔️ 雷达对抗仿真测试"])
    st.markdown('</div>', unsafe_allow_html=True)
