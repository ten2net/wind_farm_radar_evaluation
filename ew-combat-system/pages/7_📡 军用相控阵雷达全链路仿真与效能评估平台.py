...
st.markdown("""
这是一个**专业级**军用相控阵雷达系统级仿真平台，覆盖从天线阵列设计到信号处理的全链路仿真。

**核心能力**：
- 🛩️ **多型号雷达库** - 支持宙斯盾、F-22/F-35、苏-57、346型等12款经典雷达
- 📡 **阵列设计与波束控制** - 阵元配置、加权优化、自适应波束成形、3D方向图可视化
- 🎯 **目标探测与跟踪** - 多目标模拟、RCS建模、距离-多普勒分析、跟踪滤波
- 🛡️ **电子对抗与干扰抑制** - 干扰机建模、MVDR自适应零陷、抗干扰效能评估
- 📊 **信号处理与检测** - LFM脉冲压缩、匹配滤波、信噪比分析、检测概率计算
- ⚡ **系统级仿真** - 雷达方程、作战效能评估、扫描策略优化、实时动态仿真
""")
